...
{block name="page"}
	...
	<section id="project" class="mts mbm">
		...
		<p><b>{lang('milestone_view_p_7')} :</b> <span class="inbl"><span class="progressbar_holder" title="{sprintf(lang('milestone_view_p_8'), $project->getProgress(), $project->getProgressScore()|number_format:2)}"><span class="progressbar {$project->getProgressScore()|score_project}" style="width: {$project->getProgress()}%"></span></span></span>
