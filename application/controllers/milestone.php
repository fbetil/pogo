...
class Milestone extends CI_Controller {
    ...
    public function View($milestoneid) {
        ...
        ($project = $this->pogo->auth->getProject($milestone->getProjectId())) ?: $this->pogo->html->e401();
    ...
    public function Delete($milestoneid){
        ...
        //get linked project or exit if not linked to project
        ($project = $this->pogo->auth->getProject($milestone->getProjectId())) ?: $this->pogo->html->error(lang('error_not_allowed'));
