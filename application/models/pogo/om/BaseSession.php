...
abstract class BaseSession extends BaseObject implements Persistent
{
    ...
    public function setIpAddress($v)
    {
        ...
        if ($this->ip_address !== $v) {
            $this->ip_address = $v;
            $this->modifiedColumns[] = SessionPeer::IP_ADDRESS;
        }
    ...
    public function setUserAgent($v)
    {
        ...
        if ($this->user_agent !== $v) {
            $this->user_agent = $v;
            $this->modifiedColumns[] = SessionPeer::USER_AGENT;
        }
    ...
    public function setLastActivity($v)
    {
        ...
        if ($this->last_activity !== $v) {
            ...
            $this->modifiedColumns[] = SessionPeer::LAST_ACTIVITY;
        }
    ...
    public function setUserData($v)
    {
        ...
        if ($this->user_data !== $v) {
            $this->user_data = $v;
            $this->modifiedColumns[] = SessionPeer::USER_DATA;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SessionPeer::IP_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`ip_address`';
        }
        if ($this->isColumnModified(SessionPeer::USER_AGENT)) {
            $modifiedColumns[':p' . $index++]  = '`user_agent`';
        }
        if ($this->isColumnModified(SessionPeer::LAST_ACTIVITY)) {
            $modifiedColumns[':p' . $index++]  = '`last_activity`';
        }
        if ($this->isColumnModified(SessionPeer::USER_DATA)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SessionPeer::IP_ADDRESS)) $criteria->add(SessionPeer::IP_ADDRESS, $this->ip_address);
        if ($this->isColumnModified(SessionPeer::USER_AGENT)) $criteria->add(SessionPeer::USER_AGENT, $this->user_agent);
        if ($this->isColumnModified(SessionPeer::LAST_ACTIVITY)) $criteria->add(SessionPeer::LAST_ACTIVITY, $this->last_activity);
        if ($this->isColumnModified(SessionPeer::USER_DATA)) $criteria->add(SessionPeer::USER_DATA, $this->user_data);
