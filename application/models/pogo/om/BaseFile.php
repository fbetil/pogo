...
abstract class BaseFile extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->fileid !== $v) {
            $this->fileid = $v;
            $this->modifiedColumns[] = FilePeer::FILEID;
        }
    ...
    public function setFolder($v)
    {
        ...
        if ($this->filefolder !== $v) {
            $this->filefolder = $v;
            $this->modifiedColumns[] = FilePeer::FILEFOLDER;
        }
    ...
    public function setContent($v)
    {
        ...
        $this->modifiedColumns[] = FilePeer::FILECONTENT;
    ...
    public function setMimeType($v)
    {
        ...
        if ($this->filemimetype !== $v) {
            $this->filemimetype = $v;
            $this->modifiedColumns[] = FilePeer::FILEMIMETYPE;
        }
    ...
    public function setSize($v)
    {
        ...
        if ($this->filesize !== $v) {
            $this->filesize = $v;
            $this->modifiedColumns[] = FilePeer::FILESIZE;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->fileversion !== $v) {
            $this->fileversion = $v;
            $this->modifiedColumns[] = FilePeer::FILEVERSION;
        }
    ...
    public function setActorId($v)
    {
        ...
        if ($this->actorid !== $v) {
            $this->actorid = $v;
            $this->modifiedColumns[] = FilePeer::ACTORID;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->projectid !== $v) {
            $this->projectid = $v;
            $this->modifiedColumns[] = FilePeer::PROJECTID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(FilePeer::FILEID)) {
            $modifiedColumns[':p' . $index++]  = '`fileid`';
        }
        if ($this->isColumnModified(FilePeer::FILENAME)) {
            $modifiedColumns[':p' . $index++]  = '`filename`';
        }
        if ($this->isColumnModified(FilePeer::FILEFOLDER)) {
            $modifiedColumns[':p' . $index++]  = '`filefolder`';
        }
        if ($this->isColumnModified(FilePeer::FILECONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`filecontent`';
        }
        if ($this->isColumnModified(FilePeer::FILEMIMETYPE)) {
            $modifiedColumns[':p' . $index++]  = '`filemimetype`';
        }
        if ($this->isColumnModified(FilePeer::FILESIZE)) {
            $modifiedColumns[':p' . $index++]  = '`filesize`';
        }
        if ($this->isColumnModified(FilePeer::FILEVERSION)) {
            $modifiedColumns[':p' . $index++]  = '`fileversion`';
        }
        if ($this->isColumnModified(FilePeer::ACTORID)) {
            $modifiedColumns[':p' . $index++]  = '`actorid`';
        }
        if ($this->isColumnModified(FilePeer::PROJECTID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FilePeer::FILEID)) $criteria->add(FilePeer::FILEID, $this->fileid);
        if ($this->isColumnModified(FilePeer::FILENAME)) $criteria->add(FilePeer::FILENAME, $this->filename);
        if ($this->isColumnModified(FilePeer::FILEFOLDER)) $criteria->add(FilePeer::FILEFOLDER, $this->filefolder);
        if ($this->isColumnModified(FilePeer::FILECONTENT)) $criteria->add(FilePeer::FILECONTENT, $this->filecontent);
        if ($this->isColumnModified(FilePeer::FILEMIMETYPE)) $criteria->add(FilePeer::FILEMIMETYPE, $this->filemimetype);
        if ($this->isColumnModified(FilePeer::FILESIZE)) $criteria->add(FilePeer::FILESIZE, $this->filesize);
        if ($this->isColumnModified(FilePeer::FILEVERSION)) $criteria->add(FilePeer::FILEVERSION, $this->fileversion);
        if ($this->isColumnModified(FilePeer::ACTORID)) $criteria->add(FilePeer::ACTORID, $this->actorid);
        if ($this->isColumnModified(FilePeer::PROJECTID)) $criteria->add(FilePeer::PROJECTID, $this->projectid);
    ...
    {
        $criteria = new Criteria(FilePeer::DATABASE_NAME);
        $criteria->add(FilePeer::FILEID, $this->fileid);
