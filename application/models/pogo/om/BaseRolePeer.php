...
abstract class BaseRolePeer
{
    ...
    const ROLECOMMENT = 'role.rolecomment';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (RolePeer::ROLEID, RolePeer::ROLENAME, RolePeer::ROLECOMMENT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (RolePeer::ROLEID => 0, RolePeer::ROLENAME => 1, RolePeer::ROLECOMMENT => 2, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RolePeer::ROLEID);
            $criteria->addSelectColumn(RolePeer::ROLENAME);
            $criteria->addSelectColumn(RolePeer::ROLECOMMENT);
        } else {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(RolePeer::ROLEID) && $criteria->keyContainsValue(RolePeer::ROLEID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(RolePeer::ROLEID);
            $value = $criteria->remove(RolePeer::ROLEID);
            if ($value) {
                $selectCriteria->add(RolePeer::ROLEID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(RolePeer::ROLEID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(RolePeer::DATABASE_NAME);
        $criteria->add(RolePeer::ROLEID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(RolePeer::DATABASE_NAME);
            $criteria->add(RolePeer::ROLEID, $pks, Criteria::IN);
