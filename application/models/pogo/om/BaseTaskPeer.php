...
abstract class BaseTaskPeer
{
    ...
    const TASKPROGRESS = 'task.taskprogress';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (TaskPeer::TASKID, TaskPeer::TASKNAME, TaskPeer::TASKDESCRIPTION, TaskPeer::TASKSTARTDATE, TaskPeer::TASKDUEDATE, TaskPeer::TASKPROGRESS, TaskPeer::PROJECTID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (TaskPeer::TASKID => 0, TaskPeer::TASKNAME => 1, TaskPeer::TASKDESCRIPTION => 2, TaskPeer::TASKSTARTDATE => 3, TaskPeer::TASKDUEDATE => 4, TaskPeer::TASKPROGRESS => 5, TaskPeer::PROJECTID => 6, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TaskPeer::TASKID);
            $criteria->addSelectColumn(TaskPeer::TASKNAME);
            $criteria->addSelectColumn(TaskPeer::TASKDESCRIPTION);
            $criteria->addSelectColumn(TaskPeer::TASKSTARTDATE);
            $criteria->addSelectColumn(TaskPeer::TASKDUEDATE);
            $criteria->addSelectColumn(TaskPeer::TASKPROGRESS);
            $criteria->addSelectColumn(TaskPeer::PROJECTID);
        } else {
    ...
    public static function doCountJoinProject(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TaskPeer::PROJECTID, ProjectPeer::PROJECTID, $join_behavior);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(TaskPeer::TASKID) && $criteria->keyContainsValue(TaskPeer::TASKID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.TaskPeer::TASKID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(TaskPeer::TASKID);
            $value = $criteria->remove(TaskPeer::TASKID);
            if ($value) {
                $selectCriteria->add(TaskPeer::TASKID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(TaskPeer::TASKID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(TaskPeer::DATABASE_NAME);
        $criteria->add(TaskPeer::TASKID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(TaskPeer::DATABASE_NAME);
            $criteria->add(TaskPeer::TASKID, $pks, Criteria::IN);
