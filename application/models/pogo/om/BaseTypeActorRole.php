...
/**
 * Base class that represents a row from the 'typeactorrole' table.
 *
 *
 *
 * @package    propel.generator.pogo.om
 */
abstract class BaseTypeActorRole extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PoGo\\TypeActorRolePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TypeActorRolePeer
     */
     ...
     * @return TypeActorRole The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->typeactorroleid !== $v) {
            ...
            $this->modifiedColumns[] = TypeActorRolePeer::TYPEACTORROLEID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->typeactorrolecode !== $v) {
            ...
            $this->modifiedColumns[] = TypeActorRolePeer::TYPEACTORROLECODE;
        }
    ...
    public function setLabel($v)
    {
        ...
        if ($this->typeactorrolelabel !== $v) {
            ...
            $this->modifiedColumns[] = TypeActorRolePeer::TYPEACTORROLELABEL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = TypeActorRolePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TypeActorRole object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TypeActorRolePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TypeActorRoleQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TypeActorRolePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TypeActorRolePeer::TYPEACTORROLEID)) {
            $modifiedColumns[':p' . $index++]  = '`typeactorroleid`';
        }
        if ($this->isColumnModified(TypeActorRolePeer::TYPEACTORROLECODE)) {
            $modifiedColumns[':p' . $index++]  = '`typeactorrolecode`';
        }
        if ($this->isColumnModified(TypeActorRolePeer::TYPEACTORROLELABEL)) {
            $modifiedColumns[':p' . $index++]  = '`typeactorrolelabel`';
        }

        $sql = sprintf(
            'INSERT INTO `typeactorrole` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TypeActorRolePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TypeActorRolePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TypeActorRole'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TypeActorRole'][$this->getPrimaryKey()] = true;
        $keys = TypeActorRolePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TypeActorRolePeer::TYPEACTORROLEID)) $criteria->add(TypeActorRolePeer::TYPEACTORROLEID, $this->typeactorroleid);
        if ($this->isColumnModified(TypeActorRolePeer::TYPEACTORROLECODE)) $criteria->add(TypeActorRolePeer::TYPEACTORROLECODE, $this->typeactorrolecode);
        if ($this->isColumnModified(TypeActorRolePeer::TYPEACTORROLELABEL)) $criteria->add(TypeActorRolePeer::TYPEACTORROLELABEL, $this->typeactorrolelabel);
    ...
    {
        $criteria = new Criteria(TypeActorRolePeer::DATABASE_NAME);
        $criteria->add(TypeActorRolePeer::TYPEACTORROLEID, $this->typeactorroleid);
     ...
     * objects.
     *
     * @param object $copyObj An object of TypeActorRole (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TypeActorRole Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TypeActorRolePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TypeActorRolePeer();
        }
     ...
     * If this TypeActorRole is new, it will return
     ...
     * Otherwise if this TypeActorRole is new, it will return
     * an empty collection; or if this TypeActorRole has previously
     * been saved, it will retrieve related ProjectActors from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TypeActorRole.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(TypeActorRolePeer::DEFAULT_STRING_FORMAT);
    }
