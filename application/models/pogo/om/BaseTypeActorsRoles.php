...
/**
 * Base class that represents a row from the 'typeactorsroles' table.
 *
 *
 *
 * @package    propel.generator.pogo.om
 */
abstract class BaseTypeActorsRoles extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PoGo\\TypeActorsRolesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        TypeActorsRolesPeer
     */
    ...
    /**
     * The value for the typeactorroleid field.
     * @var        int
     */
    protected $typeactorroleid;

    /**
     * The value for the typeactorrolecode field.
     * @var        string
     */
    protected $typeactorrolecode;

    /**
     * The value for the typeactorrolelabel field.
     * @var        string
     */
    protected $typeactorrolelabel;
    ...
    /**
     * Get the [typeactorroleid] column value.
     *
     * @return int
     */
    public function getId()
    {
        return $this->typeactorroleid;
    }

    /**
     * Get the [typeactorrolecode] column value.
     *
     * @return string
     */
    public function getCode()
    {
        return $this->typeactorrolecode;
    }

    /**
     * Get the [typeactorrolelabel] column value.
     *
     * @return string
     */
    public function getLabel()
    {
        return $this->typeactorrolelabel;
    }

    /**
     * Set the value of [typeactorroleid] column.
     *
     * @param int $v new value
     * @return TypeActorsRoles The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->typeactorroleid !== $v) {
            $this->typeactorroleid = $v;
            $this->modifiedColumns[] = TypeActorsRolesPeer::TYPEACTORROLEID;
        }
    ...
    /**
     * Set the value of [typeactorrolecode] column.
     *
    ...
    public function setCode($v)
    {
        ...
        if ($this->typeactorrolecode !== $v) {
            $this->typeactorrolecode = $v;
            $this->modifiedColumns[] = TypeActorsRolesPeer::TYPEACTORROLECODE;
        }
    ...
    /**
     * Set the value of [typeactorrolelabel] column.
     *
     * @param string $v new value
     * @return TypeActorsRoles The current object (for fluent API support)
     */
    public function setLabel($v)
    {
        ...
        if ($this->typeactorrolelabel !== $v) {
            $this->typeactorrolelabel = $v;
            $this->modifiedColumns[] = TypeActorsRolesPeer::TYPEACTORROLELABEL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->typeactorroleid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->typeactorrolecode = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->typeactorrolelabel = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = TypeActorsRolesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TypeActorsRoles object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TypeActorsRolesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TypeActorsRolesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TypeActorsRolesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TypeActorsRolesPeer::TYPEACTORROLEID)) {
            $modifiedColumns[':p' . $index++]  = '`typeactorroleid`';
        }
        if ($this->isColumnModified(TypeActorsRolesPeer::TYPEACTORROLECODE)) {
            $modifiedColumns[':p' . $index++]  = '`typeactorrolecode`';
        }
        if ($this->isColumnModified(TypeActorsRolesPeer::TYPEACTORROLELABEL)) {
            $modifiedColumns[':p' . $index++]  = '`typeactorrolelabel`';
        }

        $sql = sprintf(
            'INSERT INTO `typeactorsroles` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`typeactorroleid`':
                        $stmt->bindValue($identifier, $this->typeactorroleid, PDO::PARAM_INT);
                        break;
                    case '`typeactorrolecode`':
                        $stmt->bindValue($identifier, $this->typeactorrolecode, PDO::PARAM_STR);
                        break;
                    case '`typeactorrolelabel`':
                        $stmt->bindValue($identifier, $this->typeactorrolelabel, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TypeActorsRolesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TypeActorsRolesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TypeActorsRoles'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TypeActorsRoles'][$this->getPrimaryKey()] = true;
        $keys = TypeActorsRolesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TypeActorsRolesPeer::TYPEACTORROLEID)) $criteria->add(TypeActorsRolesPeer::TYPEACTORROLEID, $this->typeactorroleid);
        if ($this->isColumnModified(TypeActorsRolesPeer::TYPEACTORROLECODE)) $criteria->add(TypeActorsRolesPeer::TYPEACTORROLECODE, $this->typeactorrolecode);
        if ($this->isColumnModified(TypeActorsRolesPeer::TYPEACTORROLELABEL)) $criteria->add(TypeActorsRolesPeer::TYPEACTORROLELABEL, $this->typeactorrolelabel);
    ...
    {
        $criteria = new Criteria(TypeActorsRolesPeer::DATABASE_NAME);
        $criteria->add(TypeActorsRolesPeer::TYPEACTORROLEID, $this->typeactorroleid);
    ...
    /**
     * Generic method to set the primary key (typeactorroleid column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of TypeActorsRoles (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TypeActorsRoles Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TypeActorsRolesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TypeActorsRolesPeer();
        }
     ...
     * If this TypeActorsRoles is new, it will return
    ...
    public function setProjectActors(PropelCollection $projectActors, PropelPDO $con = null)
    {
        ...
        foreach ($projectActorsToDelete as $projectActorRemoved) {
            $projectActorRemoved->setTypeActorRole(null);
        }
    ...
    protected function doAddProjectActor($projectActor)
    {
        ...
        $projectActor->setTypeActorRole($this);
    }
    ...
    public function removeProjectActor($projectActor)
    {
        if ($this->getProjectActors()->contains($projectActor)) {
            ...
            $projectActor->setTypeActorRole(null);
        }
     ...
     * Otherwise if this TypeActorsRoles is new, it will return
     * an empty collection; or if this TypeActorsRoles has previously
     * been saved, it will retrieve related ProjectActors from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in TypeActorsRoles.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        $this->typeactorroleid = null;
        $this->typeactorrolecode = null;
        $this->typeactorrolelabel = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(TypeActorsRolesPeer::DEFAULT_STRING_FORMAT);
    }
