...
abstract class BaseNote extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->noteid !== $v) {
            $this->noteid = $v;
            $this->modifiedColumns[] = NotePeer::NOTEID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->notename !== $v) {
            $this->notename = $v;
            $this->modifiedColumns[] = NotePeer::NOTENAME;
        }
    ...
    public function setContent($v)
    {
        ...
        if ($this->notecontent !== $v) {
            $this->notecontent = $v;
            $this->modifiedColumns[] = NotePeer::NOTECONTENT;
        }
    ...
    public function setActorId($v)
    {
        ...
        if ($this->actorid !== $v) {
            $this->actorid = $v;
            $this->modifiedColumns[] = NotePeer::ACTORID;
        }
    ...
    public function setPublishedAt($v)
    {
        ...
        if ($this->notepublishedat !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = NotePeer::NOTEPUBLISHEDAT;
            }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->projectid !== $v) {
            $this->projectid = $v;
            $this->modifiedColumns[] = NotePeer::PROJECTID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = NotePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = NotePeer::NOTEID;
        if (null !== $this->noteid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . NotePeer::NOTEID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(NotePeer::NOTEID)) {
            $modifiedColumns[':p' . $index++]  = '`noteid`';
        }
        if ($this->isColumnModified(NotePeer::NOTENAME)) {
            $modifiedColumns[':p' . $index++]  = '`notename`';
        }
        if ($this->isColumnModified(NotePeer::NOTECONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`notecontent`';
        }
        if ($this->isColumnModified(NotePeer::ACTORID)) {
            $modifiedColumns[':p' . $index++]  = '`actorid`';
        }
        if ($this->isColumnModified(NotePeer::NOTEPUBLISHEDAT)) {
            $modifiedColumns[':p' . $index++]  = '`notepublishedat`';
        }
        if ($this->isColumnModified(NotePeer::PROJECTID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotePeer::NOTEID)) $criteria->add(NotePeer::NOTEID, $this->noteid);
        if ($this->isColumnModified(NotePeer::NOTENAME)) $criteria->add(NotePeer::NOTENAME, $this->notename);
        if ($this->isColumnModified(NotePeer::NOTECONTENT)) $criteria->add(NotePeer::NOTECONTENT, $this->notecontent);
        if ($this->isColumnModified(NotePeer::ACTORID)) $criteria->add(NotePeer::ACTORID, $this->actorid);
        if ($this->isColumnModified(NotePeer::NOTEPUBLISHEDAT)) $criteria->add(NotePeer::NOTEPUBLISHEDAT, $this->notepublishedat);
        if ($this->isColumnModified(NotePeer::PROJECTID)) $criteria->add(NotePeer::PROJECTID, $this->projectid);
    ...
    {
        $criteria = new Criteria(NotePeer::DATABASE_NAME);
        $criteria->add(NotePeer::NOTEID, $this->noteid);
