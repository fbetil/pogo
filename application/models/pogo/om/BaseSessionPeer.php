...
abstract class BaseSessionPeer
{
    ...
    const LAST_ACTIVITY = 'session.last_activity';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (SessionPeer::SESSION_ID, SessionPeer::IP_ADDRESS, SessionPeer::USER_AGENT, SessionPeer::LAST_ACTIVITY, SessionPeer::USER_DATA, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (SessionPeer::SESSION_ID => 0, SessionPeer::IP_ADDRESS => 1, SessionPeer::USER_AGENT => 2, SessionPeer::LAST_ACTIVITY => 3, SessionPeer::USER_DATA => 4, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SessionPeer::IP_ADDRESS);
            $criteria->addSelectColumn(SessionPeer::USER_AGENT);
            $criteria->addSelectColumn(SessionPeer::LAST_ACTIVITY);
            $criteria->addSelectColumn(SessionPeer::USER_DATA);
        } else {
