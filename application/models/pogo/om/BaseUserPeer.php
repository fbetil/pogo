...
abstract class BaseUserPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (UserPeer::USERID, UserPeer::USERLOGIN, UserPeer::USERFIRSTNAME, UserPeer::USERNAME, UserPeer::USERPASSWORD, UserPeer::USEREMAIL, UserPeer::ACTORID, UserPeer::USERPROPERTIES, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (UserPeer::USERID => 0, UserPeer::USERLOGIN => 1, UserPeer::USERFIRSTNAME => 2, UserPeer::USERNAME => 3, UserPeer::USERPASSWORD => 4, UserPeer::USEREMAIL => 5, UserPeer::ACTORID => 6, UserPeer::USERPROPERTIES => 7, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::USERLOGIN);
            $criteria->addSelectColumn(UserPeer::USERFIRSTNAME);
            $criteria->addSelectColumn(UserPeer::USERNAME);
            $criteria->addSelectColumn(UserPeer::USERPASSWORD);
            $criteria->addSelectColumn(UserPeer::USEREMAIL);
            $criteria->addSelectColumn(UserPeer::ACTORID);
            $criteria->addSelectColumn(UserPeer::USERPROPERTIES);
        } else {
    ...
    public static function doCountJoinActor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserPeer::ACTORID, ActorPeer::ACTORID, $join_behavior);
    ...
    /**
     * Selects a collection of User objects pre-filled with their Actor objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinActor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (User) to $obj2 (Actor)
                $obj2->addUser($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (User) to the collection in $obj2 (Actor)
                $obj2->addUser($obj1);
