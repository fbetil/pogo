...
abstract class BaseSessions extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->session_id !== $v) {
            $this->session_id = $v;
            $this->modifiedColumns[] = SessionsPeer::SESSION_ID;
        }
    ...
    public function setUserData($v)
    {
        ...
        if ($this->user_data !== $v) {
            $this->user_data = $v;
            $this->modifiedColumns[] = SessionsPeer::USER_DATA;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SessionsPeer::SESSION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`session_id`';
        }
        if ($this->isColumnModified(SessionsPeer::IP_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`ip_address`';
        }
        if ($this->isColumnModified(SessionsPeer::USER_AGENT)) {
            $modifiedColumns[':p' . $index++]  = '`user_agent`';
        }
        if ($this->isColumnModified(SessionsPeer::LAST_ACTIVITY)) {
            $modifiedColumns[':p' . $index++]  = '`last_activity`';
        }
        if ($this->isColumnModified(SessionsPeer::USER_DATA)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SessionsPeer::SESSION_ID)) $criteria->add(SessionsPeer::SESSION_ID, $this->session_id);
        ...
        if ($this->isColumnModified(SessionsPeer::USER_DATA)) $criteria->add(SessionsPeer::USER_DATA, $this->user_data);
    ...
    {
        $criteria = new Criteria(SessionsPeer::DATABASE_NAME);
        $criteria->add(SessionsPeer::SESSION_ID, $this->session_id);
