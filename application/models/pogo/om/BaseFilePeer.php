...
abstract class BaseFilePeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (FilePeer::FILEID, FilePeer::FILENAME, FilePeer::FILEFOLDER, FilePeer::FILECONTENT, FilePeer::FILEMIMETYPE, FilePeer::FILESIZE, FilePeer::FILEVERSION, FilePeer::ACTORID, FilePeer::PROJECTID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (FilePeer::FILEID => 0, FilePeer::FILENAME => 1, FilePeer::FILEFOLDER => 2, FilePeer::FILECONTENT => 3, FilePeer::FILEMIMETYPE => 4, FilePeer::FILESIZE => 5, FilePeer::FILEVERSION => 6, FilePeer::ACTORID => 7, FilePeer::PROJECTID => 8, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(FilePeer::FILEID);
            $criteria->addSelectColumn(FilePeer::FILENAME);
            $criteria->addSelectColumn(FilePeer::FILEFOLDER);
            $criteria->addSelectColumn(FilePeer::FILECONTENT);
            $criteria->addSelectColumn(FilePeer::FILEMIMETYPE);
            $criteria->addSelectColumn(FilePeer::FILESIZE);
            $criteria->addSelectColumn(FilePeer::FILEVERSION);
            $criteria->addSelectColumn(FilePeer::ACTORID);
            $criteria->addSelectColumn(FilePeer::PROJECTID);
        } else {
    ...
    public static function doCountJoinActor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(FilePeer::ACTORID, ActorPeer::ACTORID, $join_behavior);
    ...
    public static function doCountJoinProject(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(FilePeer::PROJECTID, ProjectPeer::PROJECTID, $join_behavior);
    ...
    /**
     * Selects a collection of File objects pre-filled with their Actor objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinActor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (File) to $obj2 (Actor)
                $obj2->addFile($obj1);
    ...
    /**
     * Selects a collection of File objects pre-filled with their Project objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of File objects.
    ...
    public static function doSelectJoinProject(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (File) to $obj2 (Project)
                $obj2->addFile($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (File) to the collection in $obj2 (Actor)
                $obj2->addFile($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (File) to the collection in $obj3 (Project)
                $obj3->addFile($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of File objects pre-filled with all related objects except Actor.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptActor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = FilePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (File) to the collection in $obj2 (Project)
                $obj2->addFile($obj1);
    ...
    /**
     * Selects a collection of File objects pre-filled with all related objects except Project.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(FilePeer::FILEID) && $criteria->keyContainsValue(FilePeer::FILEID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.FilePeer::FILEID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(FilePeer::FILEID);
            $value = $criteria->remove(FilePeer::FILEID);
            if ($value) {
                $selectCriteria->add(FilePeer::FILEID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(FilePeer::FILEID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(FilePeer::DATABASE_NAME);
        $criteria->add(FilePeer::FILEID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(FilePeer::DATABASE_NAME);
            $criteria->add(FilePeer::FILEID, $pks, Criteria::IN);
