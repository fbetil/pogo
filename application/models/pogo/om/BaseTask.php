...
abstract class BaseTask extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->taskid !== $v) {
            $this->taskid = $v;
            $this->modifiedColumns[] = TaskPeer::TASKID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->taskname !== $v) {
            $this->taskname = $v;
            $this->modifiedColumns[] = TaskPeer::TASKNAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->taskdescription !== $v) {
            ...
            $this->modifiedColumns[] = TaskPeer::TASKDESCRIPTION;
        }
    ...
    public function setProgress($v)
    {
        ...
        if ($this->taskprogress !== $v) {
            $this->taskprogress = $v;
            $this->modifiedColumns[] = TaskPeer::TASKPROGRESS;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->projectid !== $v) {
            $this->projectid = $v;
            $this->modifiedColumns[] = TaskPeer::PROJECTID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TaskPeer::TASKID)) {
            $modifiedColumns[':p' . $index++]  = '`taskid`';
        }
        if ($this->isColumnModified(TaskPeer::TASKNAME)) {
            $modifiedColumns[':p' . $index++]  = '`taskname`';
        }
        if ($this->isColumnModified(TaskPeer::TASKDESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`taskdescription`';
        }
        if ($this->isColumnModified(TaskPeer::TASKSTARTDATE)) {
            $modifiedColumns[':p' . $index++]  = '`taskstartdate`';
        }
        if ($this->isColumnModified(TaskPeer::TASKDUEDATE)) {
            $modifiedColumns[':p' . $index++]  = '`taskduedate`';
        }
        if ($this->isColumnModified(TaskPeer::TASKPROGRESS)) {
            $modifiedColumns[':p' . $index++]  = '`taskprogress`';
        }
        if ($this->isColumnModified(TaskPeer::PROJECTID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaskPeer::TASKID)) $criteria->add(TaskPeer::TASKID, $this->taskid);
        if ($this->isColumnModified(TaskPeer::TASKNAME)) $criteria->add(TaskPeer::TASKNAME, $this->taskname);
        if ($this->isColumnModified(TaskPeer::TASKDESCRIPTION)) $criteria->add(TaskPeer::TASKDESCRIPTION, $this->taskdescription);
        if ($this->isColumnModified(TaskPeer::TASKSTARTDATE)) $criteria->add(TaskPeer::TASKSTARTDATE, $this->taskstartdate);
        if ($this->isColumnModified(TaskPeer::TASKDUEDATE)) $criteria->add(TaskPeer::TASKDUEDATE, $this->taskduedate);
        if ($this->isColumnModified(TaskPeer::TASKPROGRESS)) $criteria->add(TaskPeer::TASKPROGRESS, $this->taskprogress);
        if ($this->isColumnModified(TaskPeer::PROJECTID)) $criteria->add(TaskPeer::PROJECTID, $this->projectid);
    ...
    {
        $criteria = new Criteria(TaskPeer::DATABASE_NAME);
        $criteria->add(TaskPeer::TASKID, $this->taskid);
