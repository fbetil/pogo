...
/**
 * Base class that represents a row from the 'project_milestone' table.
 *
 *
 *
 * @package    propel.generator.pogo.om
 */
abstract class BaseProjectMilestone extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PoGo\\ProjectMilestonePeer';
    ...
    /**
     * The value for the projectmilestoneid field.
     * @var        int
     */
    protected $projectmilestoneid;
    ...
    /**
     * Get the [projectmilestoneid] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [projectmilestoneid] column.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->projectmilestoneid !== $v) {
            $this->projectmilestoneid = $v;
            $this->modifiedColumns[] = ProjectMilestonePeer::PROJECTMILESTONEID;
        }
     ...
     * @return ProjectMilestone The current object (for fluent API support)
     */
    public function setMilestoneId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }
        ...
        if ($this->milestoneid !== $v) {
            $this->milestoneid = $v;
            $this->modifiedColumns[] = ProjectMilestonePeer::MILESTONEID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->projectmilestoneid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->projectid = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->milestoneid = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = ProjectMilestonePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aMilestone !== null && $this->milestoneid !== $this->aMilestone->getId()) {
            $this->aMilestone = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aMilestone !== null) {
                if ($this->aMilestone->isModified() || $this->aMilestone->isNew()) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectMilestonePeer::PROJECTMILESTONEID;
        if (null !== $this->projectmilestoneid) {
        ...
        if ($this->isColumnModified(ProjectMilestonePeer::PROJECTMILESTONEID)) {
            $modifiedColumns[':p' . $index++]  = '`projectmilestoneid`';
        }
        if ($this->isColumnModified(ProjectMilestonePeer::PROJECTID)) {
            $modifiedColumns[':p' . $index++]  = '`projectid`';
        }
        if ($this->isColumnModified(ProjectMilestonePeer::MILESTONEID)) {
            $modifiedColumns[':p' . $index++]  = '`milestoneid`';
        }

        $sql = sprintf(
            'INSERT INTO `project_milestone` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`projectmilestoneid`':
                        $stmt->bindValue($identifier, $this->projectmilestoneid, PDO::PARAM_INT);
                        break;
                    case '`projectid`':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getMilestoneId(),
        );
        if ($includeForeignObjects) {
            if (null !== $this->aProject) {
                $result['Project'] = $this->aProject->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aMilestone) {
                $result['Milestone'] = $this->aMilestone->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setMilestoneId($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectMilestonePeer::PROJECTMILESTONEID)) $criteria->add(ProjectMilestonePeer::PROJECTMILESTONEID, $this->projectmilestoneid);
        if ($this->isColumnModified(ProjectMilestonePeer::PROJECTID)) $criteria->add(ProjectMilestonePeer::PROJECTID, $this->projectid);
        if ($this->isColumnModified(ProjectMilestonePeer::MILESTONEID)) $criteria->add(ProjectMilestonePeer::MILESTONEID, $this->milestoneid);
    ...
    {
        $criteria = new Criteria(ProjectMilestonePeer::DATABASE_NAME);
        $criteria->add(ProjectMilestonePeer::PROJECTMILESTONEID, $this->projectmilestoneid);
    ...
    /**
     * Generic method to set the primary key (projectmilestoneid column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMilestoneId($this->getMilestoneId());
    ...
    /**
     * Declares an association between this object and a Milestones object.
     *
     * @param             Milestones $v
     * @return ProjectMilestone The current object (for fluent API support)
     * @throws PropelException
     */
    public function setMilestone(Milestones $v = null)
    {
        if ($v === null) {
            $this->setMilestoneId(NULL);
        } else {
            $this->setMilestoneId($v->getId());
        }

        $this->aMilestone = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Milestones object, it will not be re-added.
        if ($v !== null) {
            $v->addProjectMilestone($this);
        }
    ...
    /**
     * Get the associated Milestones object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return Milestones The associated Milestones object.
     * @throws PropelException
     */
    public function getMilestone(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMilestone === null && ($this->milestoneid !== null) && $doQuery) {
            $this->aMilestone = MilestonesQuery::create()->findPk($this->milestoneid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMilestone->addProjectMilestones($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aMilestone instanceof Persistent) {
              $this->aMilestone->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(ProjectMilestonePeer::DEFAULT_STRING_FORMAT);
    }
