...
abstract class BaseUsersPeer
{
    ...
    /** the column name for the userlogin field */
    const USERLOGIN = 'users.userlogin';

    /** the column name for the userfirstname field */
    const USERFIRSTNAME = 'users.userfirstname';
    ...
    const ACTORID = 'users.actorid';

    /** the column name for the userproperties field */
    const USERPROPERTIES = 'users.userproperties';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Login', 'FirstName', 'Name', 'Password', 'Email', 'ActorId', 'Properties', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'login', 'firstName', 'name', 'password', 'email', 'actorId', 'properties', ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::USERID, UsersPeer::USERLOGIN, UsersPeer::USERFIRSTNAME, UsersPeer::USERNAME, UsersPeer::USERPASSWORD, UsersPeer::USEREMAIL, UsersPeer::ACTORID, UsersPeer::USERPROPERTIES, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USERID', 'USERLOGIN', 'USERFIRSTNAME', 'USERNAME', 'USERPASSWORD', 'USEREMAIL', 'ACTORID', 'USERPROPERTIES', ),
        BasePeer::TYPE_FIELDNAME => array ('userid', 'userlogin', 'userfirstname', 'username', 'userpassword', 'useremail', 'actorid', 'userproperties', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Login' => 1, 'FirstName' => 2, 'Name' => 3, 'Password' => 4, 'Email' => 5, 'ActorId' => 6, 'Properties' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'login' => 1, 'firstName' => 2, 'name' => 3, 'password' => 4, 'email' => 5, 'actorId' => 6, 'properties' => 7, ),
        BasePeer::TYPE_COLNAME => array (UsersPeer::USERID => 0, UsersPeer::USERLOGIN => 1, UsersPeer::USERFIRSTNAME => 2, UsersPeer::USERNAME => 3, UsersPeer::USERPASSWORD => 4, UsersPeer::USEREMAIL => 5, UsersPeer::ACTORID => 6, UsersPeer::USERPROPERTIES => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USERID' => 0, 'USERLOGIN' => 1, 'USERFIRSTNAME' => 2, 'USERNAME' => 3, 'USERPASSWORD' => 4, 'USEREMAIL' => 5, 'ACTORID' => 6, 'USERPROPERTIES' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('userid' => 0, 'userlogin' => 1, 'userfirstname' => 2, 'username' => 3, 'userpassword' => 4, 'useremail' => 5, 'actorid' => 6, 'userproperties' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UsersPeer::USERID);
            $criteria->addSelectColumn(UsersPeer::USERLOGIN);
            $criteria->addSelectColumn(UsersPeer::USERFIRSTNAME);
            $criteria->addSelectColumn(UsersPeer::USERNAME);
            $criteria->addSelectColumn(UsersPeer::USERPASSWORD);
            $criteria->addSelectColumn(UsersPeer::USEREMAIL);
            $criteria->addSelectColumn(UsersPeer::ACTORID);
            $criteria->addSelectColumn(UsersPeer::USERPROPERTIES);
        } else {
            $criteria->addSelectColumn($alias . '.userid');
            $criteria->addSelectColumn($alias . '.userlogin');
            $criteria->addSelectColumn($alias . '.userfirstname');
            ...
            $criteria->addSelectColumn($alias . '.userproperties');
        }
    }
    ...
    public static function doCountJoinActor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UsersPeer::ACTORID, ActorsPeer::ACTORID, $join_behavior);
    ...
    /**
     * Selects a collection of Users objects pre-filled with their Actors objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinActor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Users) to $obj2 (Actors)
                $obj2->addUsers($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Users) to the collection in $obj2 (Actors)
                $obj2->addUsers($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(UsersPeer::USERID) && $criteria->keyContainsValue(UsersPeer::USERID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.UsersPeer::USERID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(UsersPeer::USERID);
            $value = $criteria->remove(UsersPeer::USERID);
            if ($value) {
                $selectCriteria->add(UsersPeer::USERID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UsersPeer::USERID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(UsersPeer::DATABASE_NAME);
        $criteria->add(UsersPeer::USERID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(UsersPeer::DATABASE_NAME);
            $criteria->add(UsersPeer::USERID, $pks, Criteria::IN);
