 ...
 *
 *
 * @method ProfilesQuery orderById($order = Criteria::ASC) Order by the profileid column
 * @method ProfilesQuery orderByName($order = Criteria::ASC) Order by the profilename column
 * @method ProfilesQuery orderByComment($order = Criteria::ASC) Order by the profilecomment column
 *
 * @method ProfilesQuery groupById() Group by the profileid column
 * @method ProfilesQuery groupByName() Group by the profilename column
 * @method ProfilesQuery groupByComment() Group by the profilecomment column
 *
 ...
 *
 * @method ProfilesQuery leftJoinUserProfile($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserProfile relation
 * @method ProfilesQuery rightJoinUserProfile($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserProfile relation
 * @method ProfilesQuery innerJoinUserProfile($relationAlias = null) Adds a INNER JOIN clause to the query using the UserProfile relation
 *
 * @method ProfilesQuery leftJoinProfileRole($relationAlias = null) Adds a LEFT JOIN clause to the query using the ProfileRole relation
 * @method ProfilesQuery rightJoinProfileRole($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ProfileRole relation
 * @method ProfilesQuery innerJoinProfileRole($relationAlias = null) Adds a INNER JOIN clause to the query using the ProfileRole relation
 *
 ...
 *
 * @method Profiles findOneByName(string $profilename) Return the first Profiles filtered by the profilename column
 * @method Profiles findOneByComment(string $profilecomment) Return the first Profiles filtered by the profilecomment column
 *
 * @method array findById(int $profileid) Return Profiles objects filtered by the profileid column
 * @method array findByName(string $profilename) Return Profiles objects filtered by the profilename column
 * @method array findByComment(string $profilecomment) Return Profiles objects filtered by the profilecomment column
 *
...
abstract class BaseProfilesQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'pogo', $modelName = 'PoGo\\Profiles', $modelAlias = null)
    {
     ...
     * @param   ProfilesQuery|Criteria $criteria Optional Criteria to build the query from
     *
     ...
     *
     * @return   Profiles|Profiles[]|mixed the result, formatted by the current formatter
     */
    ...
    {
        $sql = 'SELECT `profileid`, `profilename`, `profilecomment` FROM `profiles` WHERE `profileid` = :p0';
        try {
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|Profiles[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ProfilesPeer::PROFILEID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ProfilesPeer::PROFILEID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(ProfilesPeer::PROFILEID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(ProfilesPeer::PROFILEID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProfilesPeer::PROFILEID, $id, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProfilesPeer::PROFILENAME, $name, $comparison);
    }
    ...
    public function filterByComment($comment = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProfilesPeer::PROFILECOMMENT, $comment, $comparison);
    }
    ...
    public function filterByUserProfile($userProfile, $comparison = null)
    {
        if ($userProfile instanceof UserProfile) {
            return $this
                ->addUsingAlias(ProfilesPeer::PROFILEID, $userProfile->getProfileId(), $comparison);
    ...
    public function filterByProfileRole($profileRole, $comparison = null)
    {
        if ($profileRole instanceof ProfileRole) {
            return $this
                ->addUsingAlias(ProfilesPeer::PROFILEID, $profileRole->getProfileId(), $comparison);
    ...
    {
        if ($profiles) {
            $this->addUsingAlias(ProfilesPeer::PROFILEID, $profiles->getId(), Criteria::NOT_EQUAL);
        }
