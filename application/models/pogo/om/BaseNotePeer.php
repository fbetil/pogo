...
abstract class BaseNotePeer
{
    ...
    const ACTORID = 'note.actorid';

    /** the column name for the notepublishedat field */
    const NOTEPUBLISHEDAT = 'note.notepublishedat';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (NotePeer::NOTEID, NotePeer::NOTENAME, NotePeer::NOTECONTENT, NotePeer::ACTORID, NotePeer::NOTEPUBLISHEDAT, NotePeer::PROJECTID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (NotePeer::NOTEID => 0, NotePeer::NOTENAME => 1, NotePeer::NOTECONTENT => 2, NotePeer::ACTORID => 3, NotePeer::NOTEPUBLISHEDAT => 4, NotePeer::PROJECTID => 5, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(NotePeer::NOTEID);
            $criteria->addSelectColumn(NotePeer::NOTENAME);
            $criteria->addSelectColumn(NotePeer::NOTECONTENT);
            $criteria->addSelectColumn(NotePeer::ACTORID);
            $criteria->addSelectColumn(NotePeer::NOTEPUBLISHEDAT);
            $criteria->addSelectColumn(NotePeer::PROJECTID);
        } else {
    ...
    public static function doCountJoinActor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(NotePeer::ACTORID, ActorPeer::ACTORID, $join_behavior);
    ...
    public static function doCountJoinProject(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(NotePeer::PROJECTID, ProjectPeer::PROJECTID, $join_behavior);
    ...
    /**
     * Selects a collection of Note objects pre-filled with their Actor objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinActor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Note) to $obj2 (Actor)
                $obj2->addNote($obj1);
    ...
    /**
     * Selects a collection of Note objects pre-filled with their Project objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Note objects.
    ...
    public static function doSelectJoinProject(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Note) to $obj2 (Project)
                $obj2->addNote($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Note) to the collection in $obj2 (Actor)
                $obj2->addNote($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Note) to the collection in $obj3 (Project)
                $obj3->addNote($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Note objects pre-filled with all related objects except Actor.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptActor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = NotePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Note) to the collection in $obj2 (Project)
                $obj2->addNote($obj1);
    ...
    /**
     * Selects a collection of Note objects pre-filled with all related objects except Project.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(NotePeer::NOTEID) && $criteria->keyContainsValue(NotePeer::NOTEID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(NotePeer::NOTEID);
            $value = $criteria->remove(NotePeer::NOTEID);
            if ($value) {
                $selectCriteria->add(NotePeer::NOTEID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(NotePeer::NOTEID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(NotePeer::DATABASE_NAME);
        $criteria->add(NotePeer::NOTEID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(NotePeer::DATABASE_NAME);
            $criteria->add(NotePeer::NOTEID, $pks, Criteria::IN);
