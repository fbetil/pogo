...
abstract class BaseStatus extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the statuslabel field.
     * @var        string
     */
    ...
    /**
     * Get the [statuslabel] column value.
     *
     * @return string
     */
    ...
    public function setCode($v)
    {
        ...
        if ($this->statuscode !== $v) {
            $this->statuscode = $v;
            $this->modifiedColumns[] = StatusPeer::STATUSCODE;
        }
    ...
    /**
     * Set the value of [statuslabel] column.
     *
     * @param string $v new value
     * @return Status The current object (for fluent API support)
     */
    public function setLabel($v)
    {
        ...
        if ($this->statuslabel !== $v) {
            $this->statuslabel = $v;
            $this->modifiedColumns[] = StatusPeer::STATUSLABEL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->statuscode = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->statuslabel = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StatusPeer::STATUSID)) {
            $modifiedColumns[':p' . $index++]  = '`statusid`';
        }
        if ($this->isColumnModified(StatusPeer::STATUSCODE)) {
            $modifiedColumns[':p' . $index++]  = '`statuscode`';
        }
        if ($this->isColumnModified(StatusPeer::STATUSLABEL)) {
            $modifiedColumns[':p' . $index++]  = '`statuslabel`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`statusid`':
                        ...
                        break;
                    case '`statuscode`':
                        $stmt->bindValue($identifier, $this->statuscode, PDO::PARAM_STR);
                        break;
                    case '`statuslabel`':
                        $stmt->bindValue($identifier, $this->statuslabel, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusPeer::STATUSCODE)) $criteria->add(StatusPeer::STATUSCODE, $this->statuscode);
        if ($this->isColumnModified(StatusPeer::STATUSLABEL)) $criteria->add(StatusPeer::STATUSLABEL, $this->statuslabel);
