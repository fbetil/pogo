...
use PoGo\map\UserProfileTableMap;
...
abstract class BaseUserProfilePeer
{
    ...
    const OM_CLASS = 'PoGo\\UserProfile';
    ...
    /** the column name for the userprofileid field */
    const USERPROFILEID = 'user_profile.userprofileid';

    /** the column name for the userid field */
    const USERID = 'user_profile.userid';

    /** the column name for the profileid field */
    const PROFILEID = 'user_profile.profileid';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'ProfileId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'profileId', ),
        BasePeer::TYPE_COLNAME => array (UserProfilePeer::USERPROFILEID, UserProfilePeer::USERID, UserProfilePeer::PROFILEID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USERPROFILEID', 'USERID', 'PROFILEID', ),
        BasePeer::TYPE_FIELDNAME => array ('userprofileid', 'userid', 'profileid', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'ProfileId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'profileId' => 2, ),
        BasePeer::TYPE_COLNAME => array (UserProfilePeer::USERPROFILEID => 0, UserProfilePeer::USERID => 1, UserProfilePeer::PROFILEID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('USERPROFILEID' => 0, 'USERID' => 1, 'PROFILEID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('userprofileid' => 0, 'userid' => 1, 'profileid' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UserProfilePeer::USERPROFILEID);
            $criteria->addSelectColumn(UserProfilePeer::USERID);
            $criteria->addSelectColumn(UserProfilePeer::PROFILEID);
        } else {
            $criteria->addSelectColumn($alias . '.userprofileid');
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserProfilePeer::USERID, UserPeer::USERID, $join_behavior);
    ...
    public static function doCountJoinProfile(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UserProfilePeer::PROFILEID, ProfilePeer::PROFILEID, $join_behavior);
    ...
    /**
     * Selects a collection of UserProfile objects pre-filled with their Profile objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of UserProfile objects.
    ...
    public static function doSelectJoinProfile(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (UserProfile) to $obj2 (Profile)
                $obj2->addUserProfile($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (UserProfile) to the collection in $obj3 (Profile)
    ...
    public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = UserProfilePeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (UserProfile) to the collection in $obj2 (Profile)
                $obj2->addUserProfile($obj1);
    ...
    /**
     * Selects a collection of UserProfile objects pre-filled with all related objects except Profile.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(UserProfilePeer::USERPROFILEID) && $criteria->keyContainsValue(UserProfilePeer::USERPROFILEID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.UserProfilePeer::USERPROFILEID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(UserProfilePeer::USERPROFILEID);
            $value = $criteria->remove(UserProfilePeer::USERPROFILEID);
            if ($value) {
                $selectCriteria->add(UserProfilePeer::USERPROFILEID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(UserProfilePeer::USERPROFILEID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(UserProfilePeer::DATABASE_NAME);
        $criteria->add(UserProfilePeer::USERPROFILEID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(UserProfilePeer::DATABASE_NAME);
            $criteria->add(UserProfilePeer::USERPROFILEID, $pks, Criteria::IN);
