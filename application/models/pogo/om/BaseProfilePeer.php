...
abstract class BaseProfilePeer
{
    ...
    const PROFILECOMMENT = 'profile.profilecomment';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ProfilePeer::PROFILEID, ProfilePeer::PROFILENAME, ProfilePeer::PROFILECOMMENT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ProfilePeer::PROFILEID => 0, ProfilePeer::PROFILENAME => 1, ProfilePeer::PROFILECOMMENT => 2, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ProfilePeer::PROFILEID);
            $criteria->addSelectColumn(ProfilePeer::PROFILENAME);
            $criteria->addSelectColumn(ProfilePeer::PROFILECOMMENT);
        } else {
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (ProfilePeer::$instances as $instance)
        {
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ProfilePeer::PROFILEID) && $criteria->keyContainsValue(ProfilePeer::PROFILEID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ProfilePeer::PROFILEID);
            $value = $criteria->remove(ProfilePeer::PROFILEID);
            if ($value) {
                $selectCriteria->add(ProfilePeer::PROFILEID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ProfilePeer::PROFILEID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ProfilePeer::DATABASE_NAME);
        $criteria->add(ProfilePeer::PROFILEID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ProfilePeer::DATABASE_NAME);
            $criteria->add(ProfilePeer::PROFILEID, $pks, Criteria::IN);
