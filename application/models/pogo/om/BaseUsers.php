...
abstract class BaseUsers extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[] = UsersPeer::USERID;
        }
    ...
    public function setLogin($v)
    {
        ...
        if ($this->userlogin !== $v) {
            $this->userlogin = $v;
            $this->modifiedColumns[] = UsersPeer::USERLOGIN;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->userfirstname !== $v) {
            ...
            $this->modifiedColumns[] = UsersPeer::USERFIRSTNAME;
        }
    ...
    public function setPassword($v)
    {
        ...
        if ($this->userpassword !== $v) {
            $this->userpassword = $v;
            $this->modifiedColumns[] = UsersPeer::USERPASSWORD;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->useremail !== $v) {
            $this->useremail = $v;
            $this->modifiedColumns[] = UsersPeer::USEREMAIL;
        }
    ...
    public function setActorId($v)
    {
        ...
        if ($this->actorid !== $v) {
            $this->actorid = $v;
            $this->modifiedColumns[] = UsersPeer::ACTORID;
        }
    ...
    public function setProperties($v)
    {
        ...
        if ($this->userproperties !== $v) {
            ...
            $this->modifiedColumns[] = UsersPeer::USERPROPERTIES;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UsersPeer::USERID)) {
            $modifiedColumns[':p' . $index++]  = '`userid`';
        }
        if ($this->isColumnModified(UsersPeer::USERLOGIN)) {
            $modifiedColumns[':p' . $index++]  = '`userlogin`';
        }
        if ($this->isColumnModified(UsersPeer::USERFIRSTNAME)) {
            $modifiedColumns[':p' . $index++]  = '`userfirstname`';
        }
        if ($this->isColumnModified(UsersPeer::USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '`username`';
        }
        if ($this->isColumnModified(UsersPeer::USERPASSWORD)) {
            $modifiedColumns[':p' . $index++]  = '`userpassword`';
        }
        if ($this->isColumnModified(UsersPeer::USEREMAIL)) {
            $modifiedColumns[':p' . $index++]  = '`useremail`';
        }
        if ($this->isColumnModified(UsersPeer::ACTORID)) {
            $modifiedColumns[':p' . $index++]  = '`actorid`';
        }
        if ($this->isColumnModified(UsersPeer::USERPROPERTIES)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsersPeer::USERID)) $criteria->add(UsersPeer::USERID, $this->userid);
        if ($this->isColumnModified(UsersPeer::USERLOGIN)) $criteria->add(UsersPeer::USERLOGIN, $this->userlogin);
        if ($this->isColumnModified(UsersPeer::USERFIRSTNAME)) $criteria->add(UsersPeer::USERFIRSTNAME, $this->userfirstname);
        if ($this->isColumnModified(UsersPeer::USERNAME)) $criteria->add(UsersPeer::USERNAME, $this->username);
        if ($this->isColumnModified(UsersPeer::USERPASSWORD)) $criteria->add(UsersPeer::USERPASSWORD, $this->userpassword);
        if ($this->isColumnModified(UsersPeer::USEREMAIL)) $criteria->add(UsersPeer::USEREMAIL, $this->useremail);
        if ($this->isColumnModified(UsersPeer::ACTORID)) $criteria->add(UsersPeer::ACTORID, $this->actorid);
        if ($this->isColumnModified(UsersPeer::USERPROPERTIES)) $criteria->add(UsersPeer::USERPROPERTIES, $this->userproperties);
    ...
    {
        $criteria = new Criteria(UsersPeer::DATABASE_NAME);
        $criteria->add(UsersPeer::USERID, $this->userid);
