...
use PoGo\Actor;
use PoGo\ActorPeer;
use PoGo\map\ActorTableMap;

/**
 * Base static class for performing query and update operations on the 'actor' table.
 *
 *
 *
...
abstract class BaseActorPeer
{
    ...
    const ACTORFIRSTNAME = 'actor.actorfirstname';
    ...
    {
        $toNames = ActorPeer::getFieldNames($toType);
        $key = isset(ActorPeer::$fieldKeys[$fromType][$name]) ? ActorPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ActorPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ActorPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ActorPeer::$fieldNames[$type];
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ActorPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ActorPeer::DATABASE_NAME);
     ...
     *
     * @param      Actor $obj A Actor object.
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ActorPeer::$instances[$key])) {
                return ActorPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (ActorPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        ActorPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to actor
    ...
    {
        return Propel::getDatabaseMap(ActorPeer::DATABASE_NAME)->getTable(ActorPeer::TABLE_NAME);
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ActorPeer::ACTORID) && $criteria->keyContainsValue(ActorPeer::ACTORID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ActorPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(ActorPeer::ACTORID);
            $value = $criteria->remove(ActorPeer::ACTORID);
            if ($value) {
                $selectCriteria->add(ActorPeer::ACTORID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ActorPeer::ACTORID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ActorPeer::DATABASE_NAME);
        $criteria->add(ActorPeer::ACTORID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ActorPeer::DATABASE_NAME);
            $criteria->add(ActorPeer::ACTORID, $pks, Criteria::IN);
