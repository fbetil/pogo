...
abstract class BaseUserProfile extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'PoGo\\UserProfilePeer';
    ...
    /**
     * The value for the userprofileid field.
     * @var        int
     */
    ...
    /**
     * Get the [userprofileid] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [userprofileid] column.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->userprofileid !== $v) {
            $this->userprofileid = $v;
            $this->modifiedColumns[] = UserProfilePeer::USERPROFILEID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[] = UserProfilePeer::USERID;
        }
    ...
    public function setProfileId($v)
    {
        ...
        if ($this->profileid !== $v) {
            $this->profileid = $v;
            $this->modifiedColumns[] = UserProfilePeer::PROFILEID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->userprofileid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->userid = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->profileid = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = UserProfilePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = UserProfilePeer::USERPROFILEID;
        if (null !== $this->userprofileid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . UserProfilePeer::USERPROFILEID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(UserProfilePeer::USERPROFILEID)) {
            $modifiedColumns[':p' . $index++]  = '`userprofileid`';
        }
        if ($this->isColumnModified(UserProfilePeer::USERID)) {
            $modifiedColumns[':p' . $index++]  = '`userid`';
        }
        if ($this->isColumnModified(UserProfilePeer::PROFILEID)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`userprofileid`':
                        $stmt->bindValue($identifier, $this->userprofileid, PDO::PARAM_INT);
                        break;
                    case '`userid`':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserProfilePeer::USERPROFILEID)) $criteria->add(UserProfilePeer::USERPROFILEID, $this->userprofileid);
        if ($this->isColumnModified(UserProfilePeer::USERID)) $criteria->add(UserProfilePeer::USERID, $this->userid);
        if ($this->isColumnModified(UserProfilePeer::PROFILEID)) $criteria->add(UserProfilePeer::PROFILEID, $this->profileid);
    ...
    {
        $criteria = new Criteria(UserProfilePeer::DATABASE_NAME);
        $criteria->add(UserProfilePeer::USERPROFILEID, $this->userprofileid);
    ...
    /**
     * Generic method to set the primary key (userprofileid column).
     *
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->userid !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addUserProfiles($this);
             */
        }
    ...
    public function getProfile(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProfile === null && ($this->profileid !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProfile->addUserProfiles($this);
             */
        }
