...
abstract class BaseProfile extends BaseObject implements Persistent
{
    ...
    public function setId($v)
    {
        ...
        if ($this->profileid !== $v) {
            $this->profileid = $v;
            $this->modifiedColumns[] = ProfilePeer::PROFILEID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->profilename !== $v) {
            $this->profilename = $v;
            $this->modifiedColumns[] = ProfilePeer::PROFILENAME;
        }
    ...
    public function setComment($v)
    {
        ...
        if ($this->profilecomment !== $v) {
            ...
            $this->modifiedColumns[] = ProfilePeer::PROFILECOMMENT;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null !== $this->profileid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ProfilePeer::PROFILEID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ProfilePeer::PROFILEID)) {
            $modifiedColumns[':p' . $index++]  = '`profileid`';
        }
        if ($this->isColumnModified(ProfilePeer::PROFILENAME)) {
            $modifiedColumns[':p' . $index++]  = '`profilename`';
        }
        if ($this->isColumnModified(ProfilePeer::PROFILECOMMENT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProfilePeer::PROFILEID)) $criteria->add(ProfilePeer::PROFILEID, $this->profileid);
        if ($this->isColumnModified(ProfilePeer::PROFILENAME)) $criteria->add(ProfilePeer::PROFILENAME, $this->profilename);
        if ($this->isColumnModified(ProfilePeer::PROFILECOMMENT)) $criteria->add(ProfilePeer::PROFILECOMMENT, $this->profilecomment);
    ...
    {
        $criteria = new Criteria(ProfilePeer::DATABASE_NAME);
        $criteria->add(ProfilePeer::PROFILEID, $this->profileid);
