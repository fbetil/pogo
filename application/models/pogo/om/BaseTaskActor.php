...
/**
 * Base class that represents a row from the 'task_actor' table.
 *
 *
 *
 * @package    propel.generator.pogo.om
 */
abstract class BaseTaskActor extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PoGo\\TaskActorPeer';
    ...
    /**
     * The value for the taskactorid field.
     * @var        int
     */
    protected $taskactorid;
    ...
    /**
     * Get the [taskactorid] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [taskactorid] column.
     *
     * @param int $v new value
     * @return TaskActor The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->taskactorid !== $v) {
            $this->taskactorid = $v;
            $this->modifiedColumns[] = TaskActorPeer::TASKACTORID;
        }
    ...
    public function setTaskId($v)
    {
        ...
        if ($this->taskid !== $v) {
            $this->taskid = $v;
            $this->modifiedColumns[] = TaskActorPeer::TASKID;
        }
    ...
    public function setActorId($v)
    {
        ...
        if ($this->actorid !== $v) {
            $this->actorid = $v;
            $this->modifiedColumns[] = TaskActorPeer::ACTORID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->taskactorid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = TaskActorPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating TaskActor object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TaskActorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TaskActorQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TaskActorPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = TaskActorPeer::TASKACTORID;
        if (null !== $this->taskactorid) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TaskActorPeer::TASKACTORID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TaskActorPeer::TASKACTORID)) {
            $modifiedColumns[':p' . $index++]  = '`taskactorid`';
        }
        if ($this->isColumnModified(TaskActorPeer::TASKID)) {
            $modifiedColumns[':p' . $index++]  = '`taskid`';
        }
        if ($this->isColumnModified(TaskActorPeer::ACTORID)) {
            $modifiedColumns[':p' . $index++]  = '`actorid`';
        }

        $sql = sprintf(
            'INSERT INTO `task_actor` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`taskactorid`':
                        $stmt->bindValue($identifier, $this->taskactorid, PDO::PARAM_INT);
                        break;
                    case '`taskid`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TaskActorPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TaskActorPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TaskActor'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TaskActor'][$this->getPrimaryKey()] = true;
        $keys = TaskActorPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TaskActorPeer::TASKACTORID)) $criteria->add(TaskActorPeer::TASKACTORID, $this->taskactorid);
        if ($this->isColumnModified(TaskActorPeer::TASKID)) $criteria->add(TaskActorPeer::TASKID, $this->taskid);
        if ($this->isColumnModified(TaskActorPeer::ACTORID)) $criteria->add(TaskActorPeer::ACTORID, $this->actorid);
    ...
    {
        $criteria = new Criteria(TaskActorPeer::DATABASE_NAME);
        $criteria->add(TaskActorPeer::TASKACTORID, $this->taskactorid);
    ...
    /**
     * Generic method to set the primary key (taskactorid column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of TaskActor (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return TaskActor Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TaskActorPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TaskActorPeer();
        }
    ...
    public function getTask(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTask === null && ($this->taskid !== null) && $doQuery) {
            $this->aTask = TaskQuery::create()->findPk($this->taskid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aTask->addTaskActors($this);
             */
        }
    ...
    public function getActor(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aActor === null && ($this->actorid !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aActor->addTaskActors($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(TaskActorPeer::DEFAULT_STRING_FORMAT);
    }
