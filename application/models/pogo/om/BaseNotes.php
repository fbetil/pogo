...
abstract class BaseNotes extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the notename field.
     * @var        string
     */
    protected $notename;

    /**
     * The value for the notecontent field.
     * @var        string
     */
    ...
    /**
     * The value for the notepublishedat field.
     * @var        string
     */
    protected $notepublishedat;
    ...
    /**
     * Get the [notecontent] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [optionally formatted] temporal [notepublishedat] column value.
     *
     *
    ...
    {
        if ($this->notepublishedat === null) {
            return null;
        }

        if ($this->notepublishedat === '0000-00-00 00:00:00') {
        ...
        try {
            $dt = new DateTime($this->notepublishedat);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->notepublishedat, true), $x);
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->noteid !== $v) {
            $this->noteid = $v;
            $this->modifiedColumns[] = NotesPeer::NOTEID;
        }
    ...
    /**
     * Set the value of [notename] column.
     *
    ...
    public function setName($v)
    {
        ...
        if ($this->notename !== $v) {
            $this->notename = $v;
            $this->modifiedColumns[] = NotesPeer::NOTENAME;
        }
    ...
    /**
     * Set the value of [notecontent] column.
     *
     * @param string $v new value
     * @return Notes The current object (for fluent API support)
     */
    public function setContent($v)
    {
        ...
        if ($this->notecontent !== $v) {
            $this->notecontent = $v;
            $this->modifiedColumns[] = NotesPeer::NOTECONTENT;
        }
    ...
    public function setActorId($v)
    {
        ...
        if ($this->actorid !== $v) {
            $this->actorid = $v;
            $this->modifiedColumns[] = NotesPeer::ACTORID;
        }
    ...
    /**
     * Sets the value of [notepublishedat] column to a normalized version of the date/time value specified.
     *
    ...
    public function setPublishedAt($v)
    {
        ...
        if ($this->notepublishedat !== null || $dt !== null) {
            $currentDateAsString = ($this->notepublishedat !== null && $tmpDt = new DateTime($this->notepublishedat)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->notepublishedat = $newDateAsString;
                $this->modifiedColumns[] = NotesPeer::NOTEPUBLISHEDAT;
            }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->projectid !== $v) {
            $this->projectid = $v;
            $this->modifiedColumns[] = NotesPeer::PROJECTID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->noteid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->notename = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->notecontent = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->actorid = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->notepublishedat = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            ...
            return $startcol + 6; // 6 = NotesPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NotesPeer::NOTEID)) {
            $modifiedColumns[':p' . $index++]  = '`noteid`';
        }
        if ($this->isColumnModified(NotesPeer::NOTENAME)) {
            $modifiedColumns[':p' . $index++]  = '`notename`';
        }
        if ($this->isColumnModified(NotesPeer::NOTECONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`notecontent`';
        }
        if ($this->isColumnModified(NotesPeer::ACTORID)) {
            $modifiedColumns[':p' . $index++]  = '`actorid`';
        }
        if ($this->isColumnModified(NotesPeer::NOTEPUBLISHEDAT)) {
            $modifiedColumns[':p' . $index++]  = '`notepublishedat`';
        }
        if ($this->isColumnModified(NotesPeer::PROJECTID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`noteid`':
                        ...
                        break;
                    case '`notename`':
                        $stmt->bindValue($identifier, $this->notename, PDO::PARAM_STR);
                        break;
                    case '`notecontent`':
                        $stmt->bindValue($identifier, $this->notecontent, PDO::PARAM_STR);
                        break;
                    case '`actorid`':
                        $stmt->bindValue($identifier, $this->actorid, PDO::PARAM_INT);
                        break;
                    case '`notepublishedat`':
                        $stmt->bindValue($identifier, $this->notepublishedat, PDO::PARAM_STR);
                        break;
                    case '`projectid`':
    ...
    {
        if (isset($alreadyDumpedObjects['Notes'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Notes'][$this->getPrimaryKey()] = true;
        $keys = NotesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getContent(),
            $keys[3] => $this->getActorId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setActorId($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotesPeer::NOTEID)) $criteria->add(NotesPeer::NOTEID, $this->noteid);
        if ($this->isColumnModified(NotesPeer::NOTENAME)) $criteria->add(NotesPeer::NOTENAME, $this->notename);
        if ($this->isColumnModified(NotesPeer::NOTECONTENT)) $criteria->add(NotesPeer::NOTECONTENT, $this->notecontent);
        if ($this->isColumnModified(NotesPeer::ACTORID)) $criteria->add(NotesPeer::ACTORID, $this->actorid);
        if ($this->isColumnModified(NotesPeer::NOTEPUBLISHEDAT)) $criteria->add(NotesPeer::NOTEPUBLISHEDAT, $this->notepublishedat);
        if ($this->isColumnModified(NotesPeer::PROJECTID)) $criteria->add(NotesPeer::PROJECTID, $this->projectid);
    ...
    {
        $criteria = new Criteria(NotesPeer::DATABASE_NAME);
        $criteria->add(NotesPeer::NOTEID, $this->noteid);
    ...
    /**
     * Generic method to set the primary key (noteid column).
     *
    ...
    {
        return (string) $this->exportTo(NotesPeer::DEFAULT_STRING_FORMAT);
    }
