...
/**
 * This class defines the structure of the 'milestones' table.
 *
 *
 *
 ...
 */
class MilestonesTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'pogo.map.MilestonesTableMap';
    ...
    {
        // attributes
        $this->setName('milestones');
        $this->setPhpName('Milestones');
        $this->setClassname('PoGo\\Milestones');
